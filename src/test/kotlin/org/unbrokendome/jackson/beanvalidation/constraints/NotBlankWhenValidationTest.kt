...
class NotBlankWhenValidationTest : AbstractValidationTest() {
    ...
    @JsonCreator constructor(
            ...
            @NotBlankWhen(field = "hasDetails", value = "true")
            val details: String
    )
    ...
    fun `should report violation when precondition is matched and value is null`() {
        ...
        assertThat(violations).hasViolation<NotBlankWhen>("details")
    }

    @Test
    fun `should report violation when precondition is matched and value is empty`() {
    ...
    @Test
    fun `should report violation when precondition is matched and value is blank`() {
